...
const AppStoreLaunchQa = () => {
  const steps = [
    { title: "TestFlight & Play Internal Beta", desc: "Distribute pre-release builds to internal stakeholders and external beta testers seamlessly." },
    { title: "Automated Device Matrix Testing", desc: "Run automated E2E tests across 20+ real physical iOS & Android devices using AWS Device Farm." },
    { title: "Pre-Release Store Guidelines Audit", desc: "Verify Apple Human Interface Guidelines and Google Play Developer Program policies prior to review." },
    { title: "Phased Rollout Strategy", desc: "Deploy new app releases to 5% -> 20% -> 100% of user bases to catch unexpected production bugs early." }
  ];
    ...
    <div className="w-full bg-[#FBFDFD] pt-32 sm:pt-40 pb-24 text-slate-800 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#004658]/10 border border-[#004658]/20 text-[#004658] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6">
          ...
          <span>🚀 App Store Launch & Mobile QA</span>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="bg-[#004658] text-white rounded-3xl p-8 sm:p-12 text-center shadow-xl">
          <h3 className="text-2xl sm:text-4xl font-bold font-['Outfit',sans-serif] mb-4">Preparing for an App Store Release?</h3>
          <p className="text-slate-200 text-sm sm:text-base max-w-2xl mx-auto mb-8">Let our Mobile QA Leads review your TestFlight build before submitting to Apple & Google.</p>
          <Link to="/schedule-consultation" className="px-8 py-3.5 rounded-full bg-white text-[#004658] font-bold text-sm sm:text-base hover:bg-slate-100 transition-all inline-block shadow-lg">
            Schedule Pre-Launch QA Session
          </Link>
        </div>
      </div>
    </div>
...
export default AppStoreLaunchQa;
