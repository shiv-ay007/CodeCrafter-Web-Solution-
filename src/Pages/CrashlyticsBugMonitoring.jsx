...
const CrashlyticsBugMonitoring = () => {
  const specs = [
    { title: "Real-Time Crash Stack Trace Alerts", desc: "Instant Slack and PagerDuty notifications with unminified de-obfuscated stack traces when production crashes occur." },
    { title: "ANR & Frozen Frame Monitoring", desc: "Track Android ANR (App Not Responding) events and iOS frozen frames to maintain 99.9% crash-free session rates." },
    { title: "User Breadcrumb & Environment Logging", desc: "Capture user action breadcrumbs, OS version, device model, and battery state prior to every crash." },
    { title: "Automated Bug Triage & Hotfixes", desc: "Categorize crashes by impact and dispatch emergency hotfix builds via OTA CodePush within hours." }
  ];
    ...
    <div className="w-full bg-[#FBFDFD] pt-32 sm:pt-40 pb-24 text-slate-800 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#004658]/10 border border-[#004658]/20 text-[#004658] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6">
          ...
          <span>🔍 Firebase Crashlytics & Bug Monitoring</span>
        </div>
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold text-slate-950 tracking-tight leading-[1.15] max-w-4xl mx-auto mb-6 font-['Outfit',sans-serif]">
          Maintain a 99.9% Crash-Free{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#004658] via-[#005a72] to-[#00a8cc]">
            Mobile User Session Rate
          </span>
        </h1>

        <p className="text-base sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-10 font-normal">
          We integrate Firebase Crashlytics and Sentry to monitor production mobile crashes, track ANRs, and resolve bugs before they affect app store reviews.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="bg-[#004658] text-white rounded-3xl p-8 sm:p-12 text-center shadow-xl">
          <h3 className="text-2xl sm:text-4xl font-bold font-['Outfit',sans-serif] mb-4">Experiencing Production App Crashes?</h3>
          <p className="text-slate-200 text-sm sm:text-base max-w-2xl mx-auto mb-8">Let our Mobile Diagnostics Engineers set up real-time Crashlytics telemetry.</p>
...
export default CrashlyticsBugMonitoring;
