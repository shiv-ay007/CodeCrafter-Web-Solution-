...
const CmsDevelopment = () => {
  const cmsTypes = [
    { title: "Headless CMS (Strapi / Sanity / Contentful)", desc: "Decouple your content management from the frontend. Deliver content seamlessly to web, mobile apps, and smart devices via GraphQL APIs." },
    { title: "Custom WordPress Development", desc: "Custom theme & plugin development with zero bloat, ACF Pro integration, and high security hardening." },
    { title: "Multi-Lingual & Global Content Hubs", desc: "Manage multi-region localized content, translation workflows, and role-based editorial publishing permissions." },
    { title: "Enterprise Content Migration", desc: "Seamlessly migrate legacy content databases into modern Headless platforms without losing SEO ranking or data integrity." }
  ];
    ...
    <div className="w-full bg-[#FBFDFD] pt-32 sm:pt-40 pb-24 text-slate-800 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <p className="text-base sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-10 font-normal">
          We build flexible, lightning-fast content management systems that empower marketing teams to publish without needing developer intervention.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="bg-[#004658] text-white rounded-3xl p-8 sm:p-12 text-center shadow-xl">
          <h3 className="text-2xl sm:text-4xl font-bold font-['Outfit',sans-serif] mb-4">Want to Upgrade Your Content Infrastructure?</h3>
          <p className="text-slate-200 text-sm sm:text-base max-w-2xl mx-auto mb-8">Schedule a discovery call to learn how Headless CMS can accelerate your marketing publishing speed.</p>
