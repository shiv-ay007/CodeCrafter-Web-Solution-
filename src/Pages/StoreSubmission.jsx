...
const StoreSubmission = () => {
  const process = [
    { num: "01", title: "App Store Connect & Play Console Setup", desc: "Configure provisioning profiles, distribution certificates, API keys, and signing credentials." },
    { num: "02", title: "ASO Metadata & Screenshots", desc: "Craft localized App Store Optimization titles, keywords, high-res screenshots, and app preview videos." },
    { num: "03", title: "Privacy Nutrition Labels & Declarations", desc: "Complete mandatory Data Safety forms, encryption export compliance, and privacy disclosures." },
    { num: "04", title: "App Review & Approval Fast-Track", desc: "Direct handling of Apple/Google App Reviewer feedback with expedited re-submission if needed." }
  ];
    ...
    <div className="w-full bg-[#FBFDFD] pt-32 sm:pt-40 pb-24 text-slate-800 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#004658]/10 border border-[#004658]/20 text-[#004658] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6">
          ...
          <span>📲 Apple & Google Store Submission</span>
        </div>
        ...
        <p className="text-base sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-10 font-normal">
          We manage the end-to-end submission process for Apple App Store Connect and Google Play Console to get your app approved quickly.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {process.map((item, idx) => (
            <div key={idx} className="p-6 sm:p-8 rounded-3xl bg-white border border-[#004658]/15 shadow-sm hover:shadow-md transition-all">
              <span className="text-2xl font-extrabold text-[#004658]/30 font-['Outfit',sans-serif] block mb-2">{item.num}</span>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="bg-[#004658] text-white rounded-3xl p-8 sm:p-12 text-center shadow-xl">
          <h3 className="text-2xl sm:text-4xl font-bold font-['Outfit',sans-serif] mb-4">Facing App Store Rejection?</h3>
          <p className="text-slate-200 text-sm sm:text-base max-w-2xl mx-auto mb-8">Our Store Specialists resolve Guideline 4.0, 2.1, and Data Safety rejection issues for fast approval.</p>
          <Link to="/schedule-consultation" className="px-8 py-3.5 rounded-full bg-white text-[#004658] font-bold text-sm sm:text-base hover:bg-slate-100 transition-all inline-block shadow-lg">
            Schedule Store Submission Help
          </Link>
        </div>
      </div>
    </div>
