        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-5 sm:gap-6 mt-12 sm:mt-16">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-6 p-4 sm:p-5 rounded-2xl bg-slate-50/90 border border-slate-200/80 space-y-3">
                ...
                {/* Multi-Channel Platform Icons & Live Reach Bar */}
                <div className="flex flex-wrap items-center justify-between gap-2.5 px-3.5 py-2.5 bg-white rounded-xl border border-slate-200/70 shadow-2xs">
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Networks:</span>
                    <div className="flex items-center gap-1.5">
                      {/* Instagram */}
                      <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-tr from-amber-500 via-pink-500 to-purple-600 text-white shadow-xs" title="Instagram Reels & Stories">
                      ...
                      {/* TikTok */}
                      <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-black text-white shadow-xs" title="TikTok Video">
                        <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                          <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.24 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
                        </svg>
                      </div>
                      {/* YouTube */}
                      <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-[#FF0000] text-white shadow-xs" title="YouTube Shorts">
                        <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                          <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                        </svg>
                      </div>
                      {/* LinkedIn */}
                      <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-[#0A66C2] text-white shadow-xs" title="LinkedIn Viral Carousels">
                        <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                        </svg>
                      </div>
                      {/* X / Threads */}
                      <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-slate-900 text-white shadow-xs" title="X & Threads">
                        <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center gap-1.5 text-pink-600 font-bold text-[11px] bg-pink-50 px-2.5 py-1 rounded-full border border-pink-100 shrink-0">
                    <TrendingUp size={12} />
                    <span>10M+ Organic Reach</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              {/* Color Swatch & Typography / Design Tokens Widget */}
              <div className="mt-5 p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex -space-x-1.5">
                    <span className="w-6 h-6 rounded-full bg-[#004658] border-2 border-white shadow-xs" title="#004658 Deep Teal" />
                    <span className="w-6 h-6 rounded-full bg-[#EA580C] border-2 border-white shadow-xs" title="#EA580C Radiant Orange" />
                    <span className="w-6 h-6 rounded-full bg-[#0F172A] border-2 border-white shadow-xs" title="#0F172A Obsidian" />
                    <span className="w-6 h-6 rounded-full bg-cyan-400 border-2 border-white shadow-xs" title="#22D3EE Cyan" />
                  </div>
                ...
                <div className="pt-2 border-t border-slate-200/70 flex items-center justify-between text-[11.5px] text-slate-600">
                  <div className="flex items-center gap-1.5">
                    <CheckCircle2 size={13} className="text-[#004658]" />
            ...
            <div className="relative z-10">
              ...
              <div className="mt-5 p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 space-y-2.5">
                ...
                <div className="pt-2 border-t border-slate-200/70 flex items-center justify-between text-[11.5px] text-slate-600">
                  <div className="flex items-center gap-1.5">
                    <Sparkles size={13} className="text-[#EA580C]" />
                    <span className="font-medium">Studio 3D Renders</span>
                  </div>
                  <span className="font-mono text-[10px] font-bold text-orange-700 bg-orange-50 px-1.5 py-0.5 rounded border border-orange-100">
                    Ultra-HD Quality
                  </span>
                </div>
              </div>
