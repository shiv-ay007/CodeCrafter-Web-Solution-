      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
        ...
        <div className="lg:col-span-6 text-left">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
            ...
            Complete School, College & Learning Management System (LMS)
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 leading-[1.08] mb-6">
            Smart Education. <br />
            Automated Fees. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#004658] via-[#006680] to-[#00D8FF]">School ERP & LMS.</span>
          </h1>

          <p className="text-base sm:text-lg text-slate-600 font-normal leading-relaxed mb-8 max-w-xl">
            Empower educators, parents, and students with an all-in-one institutional management platform. Online fee collection, exam report cards, live class streaming, and student GPS bus tracking.
          </p>

          <div className="grid grid-cols-3 gap-3 p-4 rounded-2xl bg-white border border-[#004658]/15 shadow-sm mb-8">
            <div>
              <span className="text-xl font-black text-[#004658] block">Online</span>
              <span className="text-xs font-bold text-slate-900">Fee Gateway</span>
            </div>
            <div>
              <span className="text-xl font-black text-emerald-600 block">Parent App</span>
              <span className="text-xs font-bold text-slate-900">Live Attendance</span>
            </div>
            <div>
              <span className="text-xl font-black text-cyan-600 block">LMS</span>
              <span className="text-xs font-bold text-slate-900">Quiz & Video Hub</span>
            </div>
          </div>
        ...
        {/* Right Column: EdTech Portal Simulator */}
        <div className="lg:col-span-6">
          <div className="relative rounded-3xl bg-slate-900 p-6 sm:p-8 text-white border border-slate-800 shadow-2xl overflow-hidden font-sans">
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-800">
              <span className="text-xs font-mono text-cyan-400 font-bold">EDTECH CAMPUS ERP</span>
              <span className="text-xs font-mono text-emerald-400 font-bold">ACADEMIC 2026</span>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xl font-mono font-bold text-white">2,850 Students</div>
                </div>
                <span className="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 text-xs font-mono font-bold">96.4% Term Fees Paid</span>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-center">
                  <span className="text-[10px] text-slate-400 block">Active Online Classes</span>
                  <span className="text-base font-mono font-bold text-cyan-400 block mt-1">18 Live Rooms</span>
                </div>
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-center">
                  <span className="text-[10px] text-slate-400 block">Campus GPS Buses</span>
                  <span className="text-base font-mono font-bold text-emerald-400 block mt-1">12 En Route</span>
                </div>
              </div>
            </div>
          </div>
